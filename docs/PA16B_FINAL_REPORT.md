...
- `artifacts/pa16-visual-validation/`: 22 current 430 × 932 application captures.
...
| Complete root regression | PASS — 72/72 suites, 13,521 checks |
...
| 430 × 932 visual fixture | PASS — 22/22 captured |
